package com.jtepic.mcspace.world.dimension;
...
public class ModDimensions {
    ...
    public static final RegistryKey<DimensionType> MOON_DIM_TYPE = RegistryKey.of(RegistryKeys.DIMENSION_TYPE,
            Identifier.of(MCSpace.MOD_ID, "moondim_type"));

    // Set Dimension Settings, changes affects old/new worlds
